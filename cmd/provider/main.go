...
import (
	...
	"github.com/jerrymccollom/provider-sample/apis"
	"github.com/jerrymccollom/provider-sample/internal/controller"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-sample"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-sample",
